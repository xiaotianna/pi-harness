...
- [references/fastapi-vite/backend/pyproject.toml](references/fastapi-vite/backend/pyproject.toml)
- [references/fastapi-vite/frontend/package.json](references/fastapi-vite/frontend/package.json)
- [references/fastapi-vite/frontend/vite.config.ts](references/fastapi-vite/frontend/vite.config.ts)
- [references/fastapi-vite/vercel.json](references/fastapi-vite/vercel.json)
