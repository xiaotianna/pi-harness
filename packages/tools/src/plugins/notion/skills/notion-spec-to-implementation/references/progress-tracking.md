...
Read the accessible task entries through the access guide, then aggregate actual status values locally. Report incomplete pagination and do not treat draft statuses as remote updates.
