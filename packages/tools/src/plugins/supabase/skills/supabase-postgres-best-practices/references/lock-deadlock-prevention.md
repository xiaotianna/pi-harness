...
A single statement can express the update, but does not guarantee lock ordering or prevent deadlocks:

```sql
-- Still handle deadlock retries and acquire locks in a consistent order
begin;
update accounts
